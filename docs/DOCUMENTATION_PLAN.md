# GPT Academic Next 文档撰写规划

> **文档版本**: v1.0
> **创建日期**: 2025-01-09
> **首要目标**: 教导用户如何配置和使用 GPT Academic Next
...
```yaml
site_name: GPT Academic Next
site_url: https://github.com/binary-husky/gpt_academic
site_description: "GPT Academic Next - 为GPT/LLM提供实用化交互界面，特别优化论文阅读/润色/写作体验"
site_author: "GPT Academic Next Team"
repo_url: https://github.com/binary-husky/gpt_academic
repo_name: binary-husky/gpt_academic
copyright: "Copyright &copy; 2025 GPT Academic Next Team"
