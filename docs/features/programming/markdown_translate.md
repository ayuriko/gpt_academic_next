...
技术文档和项目 README 通常采用 Markdown 格式编写，它们是开发者理解项目、学习技术的重要资料。GPT Academic Next 提供了专门的 Markdown 翻译功能，可以将英文技术文档翻译为中文，或将中文文档翻译为英文，同时完整保留 Markdown 的格式标记，确保翻译后的文档可以直接使用。
