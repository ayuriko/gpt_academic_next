...
文献调研是学术研究的第一步。在 Google Scholar 上搜索到一堆相关论文后，您需要逐个点开阅读摘要、判断相关性、记录引用信息——这个过程既费时又枯燥。GPT Academic Next 的谷歌学术检索助手能够自动解析您的搜索结果页面，批量提取论文信息并翻译摘要，让文献筛选效率提升数倍。
...
在 GPT Academic Next 的输入框中粘贴刚才复制的 Google Scholar URL，然后在函数插件区找到 **学术** 分类，点击 **谷歌学术检索助手** 插件按钮。
