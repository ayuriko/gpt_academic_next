...
对于无法从 Arxiv 获取源码的论文，或者您手头已有 PDF 文件的场景，GPT Academic Next 提供了直接翻译 PDF 文档的功能。系统会智能解析 PDF 内容，将学术论文翻译成中文，并尽可能保留原有的结构和格式。
...
[GROBID](https://grobid.readthedocs.io/) 是一个开源的学术文档解析服务，专门针对科研论文设计。GPT Academic Next 默认使用公共 GROBID 服务，无需您额外配置。
