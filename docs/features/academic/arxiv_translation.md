...
Arxiv 是全球最大的预印本论文平台，每天都有大量最新的学术研究发布。GPT Academic Next 提供了一键翻译 Arxiv 论文的功能，不仅能将论文内容翻译成中文，还能保留原有的 LaTeX 排版格式，生成可直接阅读的 PDF 文档。
...
1. **输入论文标识**：在 GPT Academic Next 的输入框中，输入论文的 Arxiv ID 或完整 URL
...
GPT Academic Next 提供了翻译结果的缓存和云端分享功能：
